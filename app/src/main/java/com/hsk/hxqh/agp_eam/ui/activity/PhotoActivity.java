...
import com.hsk.hxqh.agp_eam.adpter.ImageLoadAdapter;
...
public class PhotoActivity extends BaseActivity implements ImageLoadAdapter.OnRecyclerViewItemClickListener {
    ...
    protected void findViewById() {
        ...
        uploadImgeView = (ImageView) findViewById(R.id.title_more);
    ...
    protected void initView() {
        ...
        uploadImgeView.setBackgroundResource(R.drawable.ic_add);
...
//                break;
    ...
    private String getUrls(String url) {
        ...
        imagesUrl = AccountUtils.getIpAddress(PhotoActivity.this);
